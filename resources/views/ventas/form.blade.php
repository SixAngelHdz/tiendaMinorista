    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('carrito.store') }}" method="POST" id="formAgregarProducto">
                    @csrf
                    <div class="mb-3">
                        <label for="nombreProducto" class="form-label">Producto</label>
                        <input type="text" class="form-control" id="nombreProducto" value="Nombre Producto" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="precioProducto" class="form-label">Precio</label>
                        <!-- Usar readonly en lugar de disabled para que se envíe el valor -->
                        <input type="text" class="form-control" id="precioProducto" value="100" readonly name="precio">
                    </div>
                    <div class="mb-3">
                    ...
                    <input type="hidden" id="idProducto" name="id_producto" value="1">
                    <input type="hidden" id="idCliente" name="id_cliente" value="123">
